...
CUDA_VISIBLE_DEVICES=5 python /data2/npl/ICEK/Image-captioning-for-Vietnamese/src/official_train_v3_cleaned.py  --num_epoch 2 --out_dir "/data2/npl/ICEK/Image-captioning-for-Vietnamese/output5" --train_batch_size 4